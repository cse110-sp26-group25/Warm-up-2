...
const GameLogic = (() => {
   ...
   *   to the caller.
   *
   *   Counts consecutive left-to-right matches from reel 0 and looks up
   *   the multiplier table. Also flags a near-miss when `CONFIG.NEAR_MISS_HIGHS`
   *   high-value symbols appear anywhere on the line.
