  ...
  return {
    ...
    async load() {
      try {
        ...
        // Iteration 21 — verbose cert-loaded info gated behind
        // GameLogic.CONFIG.DEBUG_MODE or window.__ROBO_SLOTS_DEBUG.
        // Production console stays clean; developers can toggle in.
        const debugMode =
          (typeof GameLogic !== 'undefined' &&
           GameLogic.CONFIG &&
           GameLogic.CONFIG.DEBUG_MODE === true) ||
